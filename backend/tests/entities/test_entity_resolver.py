...
Key invariants tested:
  ...
  - A role mailbox creates no person; a generic-domain person creates no company.
"""
...
async def test_resolve_role_address_creates_no_person(db_session: AsyncSession) -> None:
    org = uuid4()
    resolver = _resolver(db_session)
