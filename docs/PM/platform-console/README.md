...
| [PC-06](EPIC-PC-06-erasure.md) | GDPR erasure (legal-hold-beats-erasure) + compliance export + UI | ✅ Done | `feat/platform-erasure` | [audit](../../audits/2026-06-01_platform-erasure-pr6-review.md) |
